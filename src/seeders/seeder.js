...
const uri =
    "mongodb+srv://rakhaab_db_user:godenzonen@cluster0.1n4kexr.mongodb.net/property_rental?retryWrites=true&w=majority&appName=Cluster0";

const modelMap = {
    Booking: require(path.join(modelsPath, "booking.model.js")),
    Customer: require(path.join(modelsPath, "customer.model.js")),
    User: require(path.join(modelsPath, "user.model.js")),
};
...
async function seed() {
    try {
        ...
        for (const entry of data) {
            const Model = modelMap[entry.model];
            if (!Model) continue;
            ...
            if (entry.model === "User") {
                for (const document of entry.documents) {
                    document.password = await bcrypt.hash(document.password, 8);
                }
            }

            if (entry.documents && entry.documents.length) {
                await Model.insertMany(entry.documents);
            }
        }
        ...
        documents: [
            {
                ...
                propertyId: {
                    _id: new mongoose.Types.ObjectId(
                        "6a561e81f0731c0037f99bef",
                    ),
                    name: "Sentul Signature Hotel",
                    price: 450,
                    duration: 2,
                },
                total: 900,
                customerId: new mongoose.Types.ObjectId(
                    "5e96cbe292b97300fc903333",
                ),
                bankId: new mongoose.Types.ObjectId("6a55d904ee53845bde4e7520"),
                payment: {
                    proofOfPayment: "images/bukti.jpeg",
                    sourceBank: "BCA",
                    status: "Proses",
                    sourceBankHolder: "ang",
                },
            },
        ],
    },
    {
        ...
        documents: [
            ...
            },
            {
                ...
                firstName: "Elshanum",
                lastName: "Gefanda",
                email: "elshanumgefanda@gmail.com",
                phoneNumber: "082377954008",
            },
        ],
    },
